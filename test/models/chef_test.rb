...
class ChefTest < ActiveSupport::TestCase
    ...
    def setup
        @chef = Chef.new(chefname: "Manuel", email: "mastervado98@gmail.com", 
    ...
    test 'email should accept valid format' do
        valid_emails = %w[user@example.com MANUEL@gmail.com M.first@yahoo.ca john+smith@co.uk.org]
    ...
    test 'reject invalid addresses' do
        invalid_emails = %w[manuel@example manuel@example,com manuel.name@gmail. joe@bar+foo.com]
